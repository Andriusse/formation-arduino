...
#include "tft_visual_framework.c"
...
void screenCadreY(uint8_t y, uint8_t height, const char *title) {
  ...
  tft.print(title);
  tft.drawRect(2, y + 30, tft.width() - 4, height - 18, 0xFFFF);
...
void setup() {
  ...
  screenSetup();
  delay(2000);
  makeCadre(2, 10, tft.width() / 2 - 4, tft.height() - 25 / 2, "V en A0");
}
/**
